...
IF @SUCURSAL=1
	...
	VALUES(1, 'WIÑAY - Depósito', 'WIÑAY S.A.','30-70761233-5','Ruta 19 Km. 7 1/2','','MERCADO DE ABASTO (Cba.)','270266185','09/2005',401010101,201020100,401010201,401010301,201010100,101020100);
IF @SUCURSAL=2
	INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
	VALUES(2, 'WIKI S.A. - Nave 3 Pto 305-307', 'WIKI S.A.','30-70992865-8','Ruta 19 Km. 7 1/2','Nave 3 Puesto 305/307','MERCADO DE ABASTO (Cba.)','270647821','05/2007',401010100,201020100,401010200,401010300,201010100,101020100);
IF @SUCURSAL=3
	INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
	VALUES(3, 'WIÑAY - Nave 7 Pto. 702', 'WIÑAY S.A.','30-70761233-5','Ruta 19 Km. 7 1/2','Nave 7 Puesto 702/704','MERCADO DE ABASTO (Cba.)','270266185','09/2005',401010102,201020100,401010202,401010302,201010100,101020100);
IF @SUCURSAL=4
	INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
	VALUES(4, 'WIÑAY - Villa María', 'WIÑAY S.A.','30-70761233-5','Puerto Rico y Caudillos Federales Km. 556','Puesto 24','MERCADO DE ABASTO SEM (Villa María)','270266185','09/2005',401010103,201020100,401010203,401010303,201010100,101020100);
IF @SUCURSAL=5
	INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
	VALUES(5, 'WIÑAY - Río Cuarto', 'WIÑAY S.A.','30-70761233-5','Ob. Buteler y Garibaldi','Puesto 27 y 28','MERCADO DE ABASTO RIO CUARTO S.A.','270266185','03/07/2001',401010104,201020100,401010204,401010304,201010100,101020100);
IF @SUCURSAL=6
	INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
	VALUES(6, 'FRUTICOLA CENTRO - Nave 3 - Pto. 324', 'FRUTICOLA CENTRO SRL','30-57077853-2','Ruta 19 Km. 7 1/2','Nave 3 Puesto 324','MERCADO DE ABASTO (Cba.)','200106296','01/07/1988',401010100,201020100,401010200,401010300,201010100,101020100);
IF @SUCURSAL=7
	INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
	VALUES(7, 'WIÑAY - Sucursal 6', 'WIÑAY S.A.','30-70761233-5','Ruta 19 Km. 7 1/2','Puesto 107','MERCADO DE ABASTO (Cba.)','270266185','09/2005',401010105,201020100,401010205,401010305,201010100,101020100);
...
*/
--INSERT INTO Empresa (Codigo, RazonSocial,CUIT, CuentaContableVentaSucursal,CuentaContableIvaDebitoSucursal) VALUES(7, 'WIÑAY S.A.','30-70761233-5',11,401010105,2130205);


INSERT INTO PorcentajesIva VALUES (1,10.50);
INSERT INTO PorcentajesIva VALUES (2,21.00);
INSERT INTO PorcentajesIva VALUES (3,27.00);
...
INSERT INTO Puestos VALUES (3,'Administrativo',1,1);
...
INSERT INTO Empleados VALUES (1,1,'Campetella', 'Jorge', 1,'28775160', 'M','22/10/1981', 'Marcelo T de Alvear 334', 'Centro', '5000', 2, '01/05/2010', '20-28775160-6', 1, 2,0,1,1,1);
INSERT INTO Empleados VALUES (2,2,'Bordarampe', 'Jorge', 1,'28775160', 'M','22/10/1981', 'Marcelo T de Alvear 334', 'Centro', '5000', 2, '01/05/2010', '20-28775160-6', 1, 2,0,1,1,1);

INSERT INTO Usuarios VALUES (2,2,'coke','NdXdcB0Vb6nokJa2+OmGaw==','-6703919',1);
...
INSERT INTO Menus VALUES (42, 'Anulación de Comprobantes',7);
INSERT INTO Menus VALUES (43, 'Notas de Crédito',7)
INSERT INTO Menus VALUES (44, 'Por Devolución de Mercadería',7);
INSERT INTO Menus VALUES (45, 'Por Ajuste de Precio',7);
INSERT INTO Menus VALUES (46, 'Notas de Débito',7);
INSERT INTO Menus VALUES (47, 'Liquidación de Remitos de Clientes',7);
INSERT INTO Menus VALUES (48, 'Liquidación de Remitos de Proveedores',5);
...
INSERT INTO Menus VALUES (58, 'Anulación de Comprobantes',5);
...
INSERT INTO Menus VALUES (65, 'Distribución de Guías',9);
...
INSERT INTO Menus VALUES (69, 'Integración de datos',1);
INSERT INTO Menus VALUES (70, 'Informe de Mermas',1);
INSERT INTO Menus VALUES (71, 'Ventas Iniciales',7);
INSERT INTO Menus VALUES (72, 'Saldo Inicial Caja',8);
INSERT INTO Menus VALUES (73, 'Movimientos Bancarios',3);
/*
IF @IDSUC=1 OR @IDSUC=2 OR @IDSUC=6
	BEGIN
...
VALUES (0,'Ninguno','',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (1,'Remitos de Clientes','R',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (2,'Facturas Electronicas "A"','A',@PUNTOELECTRONICO,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (3,'Facturas Electronicas "B"','B',@PUNTOELECTRONICO,1,1)

	INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
	VALUES (4,'Remitos de Sucursales','R',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) --Poner de Acuerdo a Factureros
VALUES (5,'Facturas Manuales "A"','A',@PUNTOVENTA,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) --Poner de Acuerdo a Factureros
VALUES (6,'Facturas Manuales "B"','B',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (7,'Recibos de Proveedores','R',@PUNTOVENTA,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (8,'Contra Recibos de Proveedores','R',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (9,'Notas de Crédito "A"','A',@PUNTOELECTRONICO,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (10,'Notas de Crédito "B"','B',@PUNTOELECTRONICO,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (11,'Notas de Débito "A"','A',@PUNTOELECTRONICO,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (12,'Notas de Débito "B"','B',@PUNTOELECTRONICO,1,1)
...
VALUES (13,'Liquidación "A"','A',@PUNTOVENTA,1,1)
...
VALUES (14,'Liquidación "B"','B',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (15,'Recibos de Clientes','R',@PUNTOVENTA,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (16,'Contra Recibos de Clientes','R',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (17,'Saldo Inicial de Clientes','S',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (18,'Saldo Inicial de Proveedores','S',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (19,'Mermas','M',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (20,'Ventas Iniciales','V',@PUNTOVENTA,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado) 
VALUES (21,'Caja Inicial','C',@PUNTOVENTA,1,1)
...
INSERT INTO CuentasContables VALUES ('101010100', 'CAJA MONEDA LOCAL', 'D', 1,1,1,1,0);	--Ingresos en efectivo
IF @SUC=2 OR @SUC=6
BEGIN
INSERT INTO CuentasContables VALUES ('101010101', 'Caja Moneda Local', 'D', 1,1,1,2,1);
END
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
INSERT INTO CuentasContables VALUES ('101010101', 'Caja Moneda Local Central', 'D', 1,1,1,1,1);
INSERT INTO CuentasContables VALUES ('101010102', 'Caja Moneda Local Nave 7', 'D', 1,1,1,1,2);
INSERT INTO CuentasContables VALUES ('101010103', 'Caja Moneda Local Villa Maria', 'D', 1,1,1,1,3);
INSERT INTO CuentasContables VALUES ('101010104', 'Caja Moneda Local Rio Cuarto', 'D', 1,1,1,1,4);
INSERT INTO CuentasContables VALUES ('101010105', 'Caja Moneda Local Sucursal 6', 'D', 1,1,1,1,5);
END
INSERT INTO CuentasContables VALUES ('101010200', 'CAJA MONEDA EXTRANJERA', 'D', 1,1,1,2,0);	--Ingresos en efectivo
IF @SUC=2 OR @SUC=6
BEGIN
INSERT INTO CuentasContables VALUES ('101010201', 'Caja Moneda Extranjera', 'D', 1,1,1,2,1);
END
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
INSERT INTO CuentasContables VALUES ('101010201', 'Caja Moneda Extranjera Central', 'D', 1,1,1,2,1);
INSERT INTO CuentasContables VALUES ('101010202', 'Caja Moneda Extranjera Nave 7', 'D', 1,1,1,2,2);
INSERT INTO CuentasContables VALUES ('101010203', 'Caja Moneda Extranjera Villa Maria', 'D', 1,1,1,2,3);
INSERT INTO CuentasContables VALUES ('101010204', 'Caja Moneda Extranjera Rio Cuarto', 'D', 1,1,1,2,4);
INSERT INTO CuentasContables VALUES ('101010205', 'Caja Moneda Extranjera Sucursal 6', 'D', 1,1,1,2,5);
END
...
--END
INSERT INTO CuentasContables VALUES ('101010300', 'VALORES A DEPOSITAR', 'D', 1,1,1,3,0);	--Ingresos en cheques
IF @SUC=2 OR @SUC=6
BEGIN
INSERT INTO CuentasContables VALUES ('101010301', 'Valores a Depositar', 'D', 1,1,1,3,1);
END
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
INSERT INTO CuentasContables VALUES ('101010301', 'Valores a Depositar Central', 'D', 1,1,1,3,1);
INSERT INTO CuentasContables VALUES ('101010302', 'Valores a Depositar Nave 7', 'D', 1,1,1,3,2);
INSERT INTO CuentasContables VALUES ('101010303', 'Valores a Depositar Villa Maria', 'D', 1,1,1,3,3);
INSERT INTO CuentasContables VALUES ('101010304', 'Valores a Depositar Rio Cuarto', 'D', 1,1,1,3,4);
INSERT INTO CuentasContables VALUES ('101010305', 'Valores a Depositar Sucursal 6', 'D', 1,1,1,3,5);
END
INSERT INTO CuentasContables VALUES ('101010400', 'BANCO', 'D', 1,1,1,4,0);		
INSERT INTO CuentasContables VALUES ('101010401', 'Banco Santander Rio', 'D', 1,1,1,4,1);
INSERT INTO CuentasContables VALUES ('101010402', 'Banco Macro', 'D', 1,1,1,4,2);
...
INSERT INTO CuentasContables VALUES ('102010200', 'Muebles y Utiles - Depreciación Acumulada', 'D', 1,2,1,2,0);
INSERT INTO CuentasContables VALUES ('102010300', 'Instalaciones - Valor de Origen', 'D', 1,2,1,3,0);
INSERT INTO CuentasContables VALUES ('102010400', 'Instalaciones - Depreciación Acumulada', 'D', 1,2,1,4,0);
INSERT INTO CuentasContables VALUES ('102010500', 'Rodados - Valor de Origen', 'D', 1,2,1,5,0);
INSERT INTO CuentasContables VALUES ('102010600', 'Rodados - Depreciación Acumulada', 'D', 1,2,1,6,0);
INSERT INTO CuentasContables VALUES ('102010700', 'Inmuebles - Valor de Origen', 'D', 1,2,1,7,0);
INSERT INTO CuentasContables VALUES ('102010800', 'Inmuebles - Depreciación Acumulada', 'D', 1,2,1,8,0);
INSERT INTO CuentasContables VALUES ('102010900', 'Maquinaria - Valor de Origen', 'D', 1,2,1,9,0);
INSERT INTO CuentasContables VALUES ('102011000', 'Maquinaria - Depreciación Acumulada', 'D', 1,2,1,10,0);
INSERT INTO CuentasContables VALUES ('102011100', 'Camara - Valor de Origen', 'D', 1,2,1,11,0);
INSERT INTO CuentasContables VALUES ('102011200', 'Camara - Depreciación Acumulada', 'D', 1,2,1,12,0);
INSERT INTO CuentasContables VALUES ('102011300', 'Sist. Informatico - Valor de Origen', 'D', 1,2,1,13,0);
INSERT INTO CuentasContables VALUES ('102011400', 'Sist. Informatico - Depreciación Acumulada', 'D', 1,2,1,14,0);
INSERT INTO CuentasContables VALUES ('102011500', 'Valor Llave - Valor de Origen', 'D', 1,2,1,15,0);
INSERT INTO CuentasContables VALUES ('102011600', 'Valor Llave - Depreciación Acumulada', 'D', 1,2,1,16,0);
INSERT INTO CuentasContables VALUES ('102011700', 'Gtos de Org y Preop - Valor de Origen', 'D', 1,2,1,17,0);
INSERT INTO CuentasContables VALUES ('102011800', 'Gtos de Org y Preop - Depreciación Acumulada', 'D', 1,2,1,18,0);
...
IF @SUC=2 OR @SUC=6
	BEGIN*/
		INSERT INTO CuentasContables VALUES ('201020100', 'AFIP - IVA Débito Fiscal', 'A', 2,1,2,1,0);
/*	END
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
	INSERT INTO CuentasContables VALUES ('201020101', 'AFIP - IVA Débito Fiscal Central', 'A', 2,1,2,1,1);
	INSERT INTO CuentasContables VALUES ('201020102', 'AFIP - IVA Débito Fiscal Nave 7', 'A', 2,1,2,1,2);
	INSERT INTO CuentasContables VALUES ('201020103', 'AFIP - IVA Débito Fiscal Villa Maria', 'A', 2,1,2,1,3);
	INSERT INTO CuentasContables VALUES ('201020104', 'AFIP - IVA Débito Fiscal Rio CUarto', 'A', 2,1,2,1,4);
	INSERT INTO CuentasContables VALUES ('201020105', 'AFIP - IVA Débito Fiscal Sucursal 6', 'A', 2,1,2,1,5);
END*/
...
IF @SUC=2 OR @SUC=6
BEGIN
	INSERT INTO CuentasContables VALUES ('401010200', 'Devolución de Mercaderia', 'A', 4,1,1,2,0);
END
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
	INSERT INTO CuentasContables VALUES ('401010201', 'Devolución de Mercaderia Central', 'A', 4,1,1,2,1);
	INSERT INTO CuentasContables VALUES ('401010202', 'Devolución de Mercaderia Nave 7', 'A', 4,1,1,2,2);
	INSERT INTO CuentasContables VALUES ('401010203', 'Devolución de Mercaderia Villa Maria', 'A',4,1,1,2,3);
	INSERT INTO CuentasContables VALUES ('401010204', 'Devolución de Mercaderia Rio Cuarto', 'A', 4,1,1,2,4);
	INSERT INTO CuentasContables VALUES ('401010205', 'Devolución de Mercaderia Sucursal 6', 'A', 4,1,1,2,5);
END
...
--INSERT INTO CuentasContables VALUES ('501010300', 'Variación de Stock', 'D', 5,1,1,3,0);
...
INSERT INTO CuentasContables VALUES ('501021700', 'Climatización', 'D', 5,1,2,17,0);
INSERT INTO CuentasContables VALUES ('501021800', 'Ropa de Trabajo', 'D', 5,1,2,18,0);
INSERT INTO CuentasContables VALUES ('501021900', 'Capacitación', 'D', 5,1,2,19,0);
...
INSERT INTO TiposDocumentosCliente VALUES (19,'Liquidación "A"', 'LQ', 0,'D', 'N', 'D', 'P',0,1)
INSERT INTO TiposDocumentosCliente VALUES (20,'Liquidación "B"', 'LQ', 0,'D', 'N', 'D', 'L',0,1)
...
INSERT INTO TiposDocumentosCliente VALUES (23,'Saldo Inicial Débito', 'SI', 17,'D', 'N', 'N', 'N',0,1)
INSERT INTO TiposDocumentosCliente VALUES (24,'Saldo Inicial Crédito', 'SI', 17,'C', 'N', 'N', 'N',0,1)
INSERT INTO TiposDocumentosCliente VALUES (25,'Venta Inicial', 'SI', 20,'C', 'N', 'N', 'N',0,1)
INSERT INTO TiposDocumentosCliente VALUES (26,'Caja Inicial', 'SI', 21,'C', 'N', 'N', 'N',0,1)
...
BEGIN
	...
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010301,1,1,0,1);
END
IF @SUC=3
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010102,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020100,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010302,1,1,0,1);
END
IF @SUC=4
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010103,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020100,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010303,1,1,0,1);
END
IF @SUC=5
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010104,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020100,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010304,1,1,0,1);
END
IF @SUC=7
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010105,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020100,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010305,1,1,0,1);
END
...
INSERT INTO TiposDocumentosProveedores VALUES (7,'Nota de Crédito Ctado "A"', 'NC',0, 'N', 'I', 'C', 'P',1)
INSERT INTO TiposDocumentosProveedores VALUES (8,'Nota de Crédito Cta Cte "A"', 'NC',0, 'C', 'N', 'C', 'P',1)
INSERT INTO TiposDocumentosProveedores VALUES (9,'Nota de Crédito Ctado "C"', 'NC',0, 'N', 'I', 'N', 'N',1)
INSERT INTO TiposDocumentosProveedores VALUES (10,'Nota de Crédito Cta Cte "C"', 'NC',0, 'C', 'N', 'N', 'N',1)
INSERT INTO TiposDocumentosProveedores VALUES (11,'Nota de Débito Ctado "A"', 'ND',0, 'N', 'E', 'D', 'P',1)
INSERT INTO TiposDocumentosProveedores VALUES (12,'Nota de Débito Cta Cte "A"', 'ND',0, 'D', 'N', 'D', 'P',1)
INSERT INTO TiposDocumentosProveedores VALUES (13,'Nota de Débito Ctado "C"', 'ND',0, 'N', 'E', 'N', 'N',1)
INSERT INTO TiposDocumentosProveedores VALUES (14,'Nota de Débito Cta Cte "C"', 'ND',0, 'D', 'N', 'N', 'N',1)
INSERT INTO TiposDocumentosProveedores VALUES (15,'Liquidación "A"', 'LQ',13, 'D', 'N', 'D', 'P',1)
INSERT INTO TiposDocumentosProveedores VALUES (16,'Liquidación "B"', 'LQ',14, 'D', 'N', 'D', 'L',1)
INSERT INTO TiposDocumentosProveedores VALUES (17,'Saldo Inicial Débito', 'SI', 18,'D', 'N', 'N', 'N',1)
INSERT INTO TiposDocumentosProveedores VALUES (18,'Saldo Inicial Crédito', 'SI', 18,'C', 'N', 'N', 'N',1)
...
INSERT INTO TiposMovimientosBancarios values (1, 'Cheque Emitido','D',-1,1,1);
INSERT INTO TiposMovimientosBancarios values (2, 'Saldo Inicial','A',1,1,1);