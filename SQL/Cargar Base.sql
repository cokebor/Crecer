...
VALUES(1, 'WIÑAY - Depósito', 'WIÑAY S.A.','30-70761233-5','Ruta 19 Km. 7 1/2','Puesto 24','MERCADO DE ABASTO (Cba.)','54268521','2016/05',401010100,201020100,401010200,401010300,201010100,101020100);
/*INSERT INTO Empresa (Codigo,NombreSucursal, RazonSocial,CUIT,Domicilio,Puesto, Domicilio2,IngresosBrutos,FechaInicioActividad,CuentaContableVentaSucursal, CuentaContableIvaDebitoSucursal, CuentaContableDebolucionMercaderiaSucursal,CuentaContableAjusteSucursal, CuentaContableCuentaCorrienteProveedores, CuentaContableCuentaCorrienteClientes) 
...
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (9,'Notas de Crédito "A"','A',2,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (10,'Notas de Crédito "B"','B',2,1,1)

INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (11,'Notas de Débito "A"','A',2,1,1)
INSERT INTO Numeradores (Codigo, Descripcion, Letra, PuntoVenta, Numero, Estado)  --Poner Punto de Venta Electronico
VALUES (12,'Notas de Débito "B"','B',2,1,1)
...
VALUES (13,'Liquidación "A"','A',1,1,1)
...
VALUES (14,'Liquidación "B"','B',1,1,1)
...
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
	INSERT INTO CuentasContables VALUES ('401010200', 'DEBOLUCION DE MERCADDERIA', 'A', 4,1,1,2,0);
END
IF @SUC=2 OR @SUC=6
BEGIN*/
...
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
	INSERT INTO CuentasContables VALUES ('401010201', 'Debolución de Mercaderia Central', 'A', 4,1,1,2,1);
	INSERT INTO CuentasContables VALUES ('401010202', 'Debolución de Mercaderia Nave 7', 'A', 4,1,1,2,2);
	INSERT INTO CuentasContables VALUES ('401010203', 'Debolución de Mercaderia Villa Maria', 'A',4,1,1,2,3);
	INSERT INTO CuentasContables VALUES ('401010204', 'Debolución de Mercaderia Rio Cuarto', 'A', 4,1,1,2,4);
	INSERT INTO CuentasContables VALUES ('401010205', 'Debolución de Mercaderia Sucursal 6', 'A', 4,1,1,2,5);
END*/
/*
IF @SUC=1 OR @SUC=3 OR @SUC=4 OR @SUC=5 OR @SUC=7
BEGIN
...
BEGIN*/
	...
	--INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020101,0,1,1,0);
...
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010101,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020102,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010201,1,1,0,1);
END
IF @SUC=4
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010101,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020103,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010201,1,1,0,1);
END
IF @SUC=5
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010101,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020104,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010201,1,1,0,1);
END
IF @SUC=7
BEGIN
	INSERT INTO FormasDePago VALUES(1,'CONTADO',101010101,1,1,1,1);
	INSERT INTO FormasDePago VALUES(2,'CUENTA CORRIENTE',101020105,0,1,1,0);
	INSERT INTO FormasDePago VALUES(3,'CHEQUE DE TERCEROS',101010201,1,1,0,1);
END
*/
