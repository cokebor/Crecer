...
namespace DatosWeb
{
    public static class Pais
    {
        ...
        public static void Agregar(Entidades.Pais pPais, Entidades.Empresa pEmpresa)
        {
            //Creo objeto conexion
            strProc = "SP_PAISES_INSERT_WEB";
            objCommand = new MySqlCommand(strProc, objConexion);
            objCommand.CommandType = CommandType.StoredProcedure;
            objCommand.Parameters.AddWithValue("@CODIGOPUESTO", pEmpresa.Codigo);
            objCommand.Parameters.AddWithValue("@CODIGOPAIS", pPais.Codigo);
            objCommand.Parameters.AddWithValue("@DESCRIPCION", pPais.Descripcion);
            objCommand.Parameters.AddWithValue("@ESTADO", (Enumeraciones.Enumeraciones.Estados)Convert.ToInt32(pPais.Estado));
            ...
            catch (MySqlException sqlex)
            {
                ...
                {
                    throw new Exception("No se pude agregar Pais, ya existe!!");
                }
        ...
        public static DataTable ObtenerNovedades(int pCodigoNovedad, Entidades.Empresa pEmpresa)
        {
            ...
            strProc = "SP_PAISES_SELECT_NOVEDADES";
