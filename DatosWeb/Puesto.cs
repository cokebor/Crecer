...
namespace DatosWeb
{
    public static class Puesto
    {
        ...
        public static void Agregar(Entidades.Puesto pPuesto, Entidades.Empresa pEmpresa)
        {
            ...
            objCommand.Parameters.AddWithValue("@ESTADO", (Enumeraciones.Enumeraciones.Estados)Convert.ToInt32(pPuesto.Estado));
