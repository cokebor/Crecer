...
namespace DatosWeb
{
    public static class TipoMovimientoBancario
    {
        ...
        public static void Agregar(Entidades.TipoMovimientoBancario pTipoMovimientoBancario, Entidades.Empresa pEmpresa)
        {
            ...
            objCommand.Parameters.AddWithValue("@ESTADO", (Enumeraciones.Enumeraciones.Estados)Convert.ToInt32(pTipoMovimientoBancario.Estado));
            ...
            catch (MySqlException sqlex)
            {
                ...
                {
                    throw new Exception("No se pude agregar Tipo de Movimiento Bancario, ya existe!!");
                }
