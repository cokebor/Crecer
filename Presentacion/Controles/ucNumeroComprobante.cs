...
{
    public partial class ucNumeroComprobante : UserControl
    {
        public ucNumeroComprobante()
        {
            InitializeComponent();
        }
        ...
        public char Letra
        {
            get
            {
                return Convert.ToChar(txtLetra.Text.Trim());
            }
        }
        ...
        public int PuntoDeVenta
        {
            get
            {
                return Convert.ToInt32(txtPuntoVenta.Text.Trim());
            }
        }
        ...
        public int Numero
        {
            get
            {
                return Convert.ToInt32(txtNumero.Text.Trim());
            }
        }
        public string Valor
        {
