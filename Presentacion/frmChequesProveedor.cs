...
namespace Presentacion
{
    ...
    public partial class frmChequesProveedor : Presentacion.frmColor
    {
        Logica.Cheque objLCheque = new Logica.Cheque();

    
        public frmChequesProveedor()//Entidades.Proveedor objProveedor)
        {
            InitializeComponent();
        ...
        private void Titulo()
        {
            this.Text = "CHEQUES EN PROVEEDORES";
        }
        ...
        public void CargarValores(Entidades.Proveedor objProveedor)
        {
            try
            {
                
                DataTable dt= objLCheque.ObtenerEnProveedor(objProveedor);
                dgvDatos.Rows.Clear();
        ...
        public void CargarValores(Entidades.Proveedor objProveedor, int pCodigoRemito)
        {
            try
            {

                DataTable dt = objLCheque.ObtenerEnProveedorPorRecibo(objProveedor, pCodigoRemito);
                dgvDatos.Rows.Clear();
                foreach (DataRow dr in dt.Rows)
                {
       ...
       //     frmFormasDePagoProveedores.busqueda = "ChequesTercerosProveedor";
            this.Hide();
        }
        ...
        */
        private void frmChequesProveedor_Load(object sender, EventArgs e)
        {
        }
    }
}