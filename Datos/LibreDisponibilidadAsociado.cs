...
namespace Datos
{
    public static class LibreDisponibilidadAsociado
    {
        ...
        static LibreDisponibilidadAsociado()
        {
            try
            {
        ...
        public static int Agregar(Entidades.Concepto pConcepto)
        {
            ...
            strProc = "SP_LIBREDISPONIBILIDADASOCIACIONES_INSERT";
            ...
            Entidades.LibreDisponibilidadAsociado conAsociado = pConcepto.LibreDisponibilidadAsociado[0];
        ...
        public static DataTable ObtenerAsociaciones(Entidades.Concepto pConcepto)
        {
            ...
            strProc = "SP_LIBREDISPONIBILIDADASOCIADOS_SELECT";
        ...
        public static void Eliminar(Entidades.LibreDisponibilidadAsociado pConcepto)
        {
            //Creo objeto conexion
            strProc = "SP_LIBREDISPONIBILIDADASOCIACION_DELETE";
            objCommand = new SqlCommand(strProc, objConexion);
            objCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            DataTable dt = new DataTable();
            strProc = "SP_LIBREDISPONIBILIDADASOCIADOS_SELECT_ACTIVOS";
            objDataAdapter = new SqlDataAdapter(strProc, objConexion);
            objDataAdapter.SelectCommand.CommandType = CommandType.StoredProcedure;
            objDataAdapter.SelectCommand.Parameters.AddWithValue("@CodigoConcepto", pConcepto.Codigo);
            try
        ...
        public static Entidades.LibreDisponibilidadAsociado ObtenerUno(int pCodigoConceptoLD)
        {
            Entidades.LibreDisponibilidadAsociado objConcepto = new Entidades.LibreDisponibilidadAsociado();
            strProc = "SP_LIBREDISPONIBILIDADASOCIADAS_SELECT_UNO";
            objCommand = new SqlCommand(strProc, objConexion);
            objCommand.CommandType = CommandType.StoredProcedure;
            objCommand.Parameters.AddWithValue("@Codigo", pCodigoConceptoLD);
            try
            {
                objConexion.Open();
